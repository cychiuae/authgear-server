...
func NewRouter(p *deps.RootProvider, configSource *configsource.ConfigSource) *httproute.Router {
	...
	router.Add(webapphandlerauthflowv2.ConfigureAuthflowV2CreateOOBOTPRoute(webappPageRoute), p.Handler(newWebAppAuthflowV2CreateOOBOTPHandler))
	...
	router.Add(webapphandlerauthflowv2.ConfigureAuthflowV2CreateTOTPRoute(webappPageRoute), p.Handler(newWebAppAuthflowV2CreateTOTPHandler))
